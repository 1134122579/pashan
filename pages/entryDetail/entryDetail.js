...
Page({
    ...
    canvas: function (t) {
        ...
        wx.getImageInfo({
            ...
            success: function (a) {
                ...
                var i, r = s.globalData.userInfoDataBase.nickName,
                    c = e.data.detail.startedAt.split("T")[0] + " " + e.data.detail.startedAt.split("T")[1].split("Z")[0],
                    d = e.data.detail.endAt.split("T")[0] + " " + e.data.detail.endAt.split("T")[1].split("Z")[0],
                    l = e.data.detail.entry;
                new Date();
                ...
                var g = e.data.h + ":" + e.data.m + ":" + e.data.s,
                    h = wx.createCanvasContext("canvas-map");
    ...
    fs: function () {
        ...
        var e = t.readFileSync("".concat(wx.env.USER_DATA_PATH, "/hello.json")),
            a = new Uint8Array(e),
            o = String.fromCharCode.apply(null, a),
            n = decodeURIComponent(escape(o));
